...
async function processScriptElements(markupProcessData) {
    ...
    cutElements(scriptElements, markupProcessData);
    orderScriptElements(scriptElements);

    let scriptBundler = new ScriptFileBundler(markupProcessData);
    await addScriptElementsToScriptBundler(scriptElements, scriptBundler);
    ...
    let closingBodyTagIndex = markupProcessData.contents.search(/<\/body>/i);
    markupProcessData.contents = util.stringInsertAt(markupProcessData.contents, closingBodyTagIndex, insertString);
...
function cutElements(scriptElements, markupProcessData) {
